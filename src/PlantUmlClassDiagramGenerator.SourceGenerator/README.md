...
### C# Sample Code
Examine how the source code described in [InputClasses.cs](/test/SourceGeneratorTest/Classes/InputClasses.cs) is converted into class diagrams.
...
```
![Item](/uml/source-generator/Item.png)
...
```
![Point](/uml/source-generator/Point.png)
...
```
![IInterface](/uml/source-generator/IInterface.png)
...
```
![BaseClass](/uml/source-generator/BaseClass`2.png)
...
```
![enum](/uml/source-generator/enum.png)
...
```
![record](/uml/source-generator/record.png)
